<script>
	...
	function onCurrencyChange() {
			console.log(`${value} option has been changed from ${currency} to ${selected}`)
			currency = selected;
	}

	function onConvertedCurrencyChange() {
			console.log(`${value} option has been changed from ${convertedCurrency} to ${selected}`)
			convertedCurrency = selected;
	}

	function onClick() {
		outputValue = `${inputValue} converted`
